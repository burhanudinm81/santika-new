@if ($mainProposal->prodi_id == 1)
    ...
    <div class="col-md-6 student-panel">
        ...
        <div class="form-group">
            ...
            <input type="number" class="form-control" id="penguasaanMateri1" name="penguasaanMateri1" min="0"
                max="100">
        </div>
        <div class="form-group">
    ...
    <div class="col-md-6 student-panel">
        ...
        <div class="form-group">
            ...
            <input type="number" class="form-control" id="penguasaanMateri2" name="penguasaanMateri2" min="0"
                max="100">
        </div>
        <div class="form-group">
            <label for="presentasi2">Kemampuan:</label>
            <input type="number" class="form-control" id="presentasi2" name="presentasi2" min="0"
                max="100">
        </div>
        <div class="form-group">
