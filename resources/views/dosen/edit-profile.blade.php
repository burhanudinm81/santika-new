                ...
                <div class="card card-primary card-outline mb-4">
                    ...
                    <form id="form-edit-profil-dosen" action="{{ route("dosen.profile.update") }}" method="post"
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                ...
                                <select name="bidang_keahlian_1" id="bidang-keahlian-1" class="custom-select">
                                    ...
                                    @foreach($bidangMinats as $bm)
                                        <option value="{{ $bm->bidang_minat }}" {{ auth('dosen')->user()->bidang_minat_1 == $bm->bidang_minat ? 'selected' : '' }}>
                                            {{ $bm->bidang_minat }}</option>
                                    @endforeach
                                </select>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <select name="bidang_keahlian_2" id="bidang-keahlian-2" class="custom-select">
                                    <option value="">-- Pilih Bidang --</option>
                                    @foreach($bidangMinats as $bm)
                                        <option value="{{ $bm->bidang_minat }}" {{ auth('dosen')->user()->bidang_minat_2 == $bm->bidang_minat ? 'selected' : '' }}>
                                            {{ $bm->bidang_minat }}</option>
                                    @endforeach
                                </select>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <select name="bidang_keahlian_3" id="bidang-keahlian-3" class="custom-select">
                                    <option value="">-- Pilih Bidang --</option>
                                    @foreach($bidangMinats as $bm)
                                        <option value="{{ $bm->bidang_minat }}" {{ auth('dosen')->user()->bidang_minat_3 == $bm->bidang_minat ? 'selected' : '' }}>
                                            {{ $bm->bidang_minat }}</option>
                                    @endforeach
                                </select>
                            </div>
                        ...
                        <div class="card-footer">
                            <button type="button" class="btn btn-secondary" id="btn-batal">Kembali</button>
