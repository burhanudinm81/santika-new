                    ...
                    <tbody>
                        @foreach ($chunk as $index => $item)
                            <tr>
                                ...
                                <td class="center-text">{{ $item->proposal->dosenPembimbing2->nama ?? "-" }}</td>
                                <td class="center-text">{{ $item->proposal->dosenPengujiSidangTA1->nama ?? "-" }}</td>
                                <td class="center-text">{{ $item->proposal->dosenPengujiSidangTA2->nama ?? "-" }}</td>
                            </tr>
                        @endforeach
                    </tbody>
                </table>
