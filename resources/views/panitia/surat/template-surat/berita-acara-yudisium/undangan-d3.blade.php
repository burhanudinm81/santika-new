    ...
    <div class="page">
        ...
        <div class="content-page1">
            ...
            <p style="margin: 5px 0; line-height: 1.3; text-align: justify;">Bersama ini kami kirimkan Berita Acara Yudisium Skripsi Semester {{ $data['semester'] ?? '' }} Tahun Akademik
                {{ $data['tahun_akademik'] ?? '' }} Program Studi Teknik Telekomunikasi Jurusan Teknik Elektro Politeknik Negeri Malang.</p>
            <br>
    ...
    <div class="page">
        ...
        <div class="content-page2">
            <div style="text-align: center; margin-bottom: 30px;">
                ...
                <p style="margin: 5px 0;">Program Studi Teknik Telekomunikasi Jurusan Teknik Elektro</p>
            ...
            <div>
                ...
                <ol style="margin: 15px 0; line-height: 1.6;">
                    ...
                    <li style="margin: 10px 0; line-height: 1.6;">Rapat Majelis Penguji Ujian Skripsi Program Studi Teknik Telekomunikasi, Jurusan Teknik
            ...
            <div>
                ...
                <ol style="margin: 15px 0; line-height: 1.6;">
                    <li style="margin: 10px 0; line-height: 1.6;">Hasil Ujian Skripsi Program Studi Teknik Telekomunikasi Jurusan Teknik Elektro</li>
                </ol>
            </div>
        </div>
    </div>
