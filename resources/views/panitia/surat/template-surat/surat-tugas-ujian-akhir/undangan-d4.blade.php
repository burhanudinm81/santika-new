...
<head>
    ...
    <title>Surat Tugas Ujian Akhir</title>
    <style>
        body {
            font-family: "Times New Roman", Times, serif;
            font-size: 16px; /* isi = 12pt Word - sama dengan template lain */
            margin: 10px 40px 20px 40px; /* atas kanan bawah kiri - sama dengan template lain */
            color: black;
            position: relative;
        }
        ...
        .header {
            text-align: center;
            line-height: 1.1; /* lebih rapat - sama dengan template lain */
            margin-bottom: 0px;
            background: white;
            position: relative; /* tidak fixed, bisa discroll */
        }
        ...
        .content {
            line-height: 1.3; /* isi lebih resmi - sama dengan template lain */
            margin-top: -10px;
...
<body>
    ...
    <div class="content">
        ...
        <p style="margin-top: 20px;" class="content-text">
            ...
            Telekomunikasi Digital Jurusan Teknik Elektro pada Semester {{ $data['semester'] ?? 'Genap' }} Tahun Akademik {{ $data['tahun_akademik'] ?? '2024/2025' }} yang
            dilaksanakan pada tanggal {{ $data['tanggal_mulai'] ?? '' }} sampai dengan {{ $data['tanggal_selesai'] ?? '' }} yang namanya tercantum di dalam kolom (4) sebagai Dosen
            Pembimbing (Utama/Pendamping) Skripsi dan kolom (5) sebagai Dosen Penguji (Ketua/Anggota) Skripsi. Adapun
            nama-nama Tenaga Pengajar tersebut terlampir pada surat tugas ini. Selesai melaksanakan tugas harap
