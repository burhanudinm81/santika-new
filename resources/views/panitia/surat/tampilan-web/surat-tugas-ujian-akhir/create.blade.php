...
@section("content-panitia")
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-7">
                    <h1 class="m-0">Input Data Surat Tugas Ujian Akhir</h1>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <form action="{{ route('panitia.surat.surat-tugas-ujian-akhir.preview') }}" method="POST">
                                @csrf
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="semester" id="semester" class="form-control" name="semester" required>
