...
@section('modals')
    <div id="modal-hapus-mahasiswa" class="modal" tabindex="-1">
        <div class="modal-dialog">
            <form action="{{ route('admin-prodi.mahasiswa.d4.delete') }}" id="form-hapus-mahasiswa" class="modal-content"
                method="post">
                @csrf
                @method('DELETE')
    ...
    <div id="modal-ganti-password-mahasiswa" class="modal" tabindex="-1">
        <div class="modal-dialog">
            <form action="{{ route("admin-prodi.mahasiswa.d4.change-password") }}" id="form-ganti-password-mahasiswa"
