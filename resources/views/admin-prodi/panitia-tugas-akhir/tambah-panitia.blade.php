    ...
    <div class="container-fluid">
        <div class="col-md-15">
            <div class="card card-default">
                <form action="{{ route("admin-prodi.panitia-tugas-akhir.tambah", ["prodi" => $prodi->id]) }}" method="post"
                    id="form-tambah-panitia" enctype="application/x-www-form-urlencoded" class="form-panitia">
                    @csrf
                    <div class="card-body">
