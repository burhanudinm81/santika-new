                                ...
                                <div class="card bg-light d-flex flex-fill">
                                    ...
                                    <div class="card-footer">
                                        <div class="text-right">
                                            <a href="{{ route('mahasiswa.informasi-dosen.profil-dosen', ['id' => $proposal->dosenPembimbing1->id]) }}"
                            ...
                            @if (!is_null($proposal->dosenPembimbing2))
                                <div class="col-12 col-sm-6 col-md-4 d-flex align-items-stretch flex-column">
                                    <div class="card bg-light d-flex flex-fill">
                                        ...
                                        <div class="card-footer">
                                            <div class="text-right">
                                                <a href="{{ route('mahasiswa.informasi-dosen.profil-dosen', ['id' => $proposal->dosenPembimbing2->id]) }}"
                                                    class="btn btn-sm btn-primary">
                                                    <i class="fas fa-user"></i> View Profile
                                                </a>
                                            </div>
                                ...
                                <div class="card bg-light d-flex flex-fill">
                                    ...
                                    <div class="card-body pt-0">
                                        <div class="row">
                                            ...
                                            <div class="col-5 text-center">
                                                <img src="{{ url('/images/blank-profile-64x64.png')}}"
                                                    alt="user-avatar" class="img-circle img-fluid">
                                            </div>
                                        </div>
                                    </div>
