                        ...
                        <div class="card-body">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="DosenPenguji1"
                                    aria-describedby="DosenPenguji1" value="{{ $mainProposalInfo->dosenPengujiSempro1->nama ?? '' }}" readonly />
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="DosenPenguji2"
                                    aria-describedby="DosenPenguji2" value="{{ $mainProposalInfo->dosenPengujiSempro2->nama ?? '' }}" readonly />
                            </div>
                            <div class="mb-3">
