                        ...
                        <div class="card-body">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="DosenPenguji1"
                                    aria-describedby="DosenPenguji1" value="{{ $mainProposalInfo->dosenPengujiSidangTA1->nama ?? '' }}" readonly />
                            </div>
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="StatusNilaiPenguji1"
                                    aria-describedby="StatusNilaiPenguji1" value="{{ $mainProposalInfo->statusSemhasPenguji1->status ?? ''}}" readonly/>
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="DosenPenguji2"
                                    aria-describedby="DosenPenguji2" value="{{ $mainProposalInfo->dosenPengujiSidangTA2->nama ?? '' }}" readonly />
                            </div>
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="StatusNilaiPenguji2"
                                    aria-describedby="StatusNilaiPenguji2" value="{{ $mainProposalInfo->statusSemhasPenguji2->status ?? ''}}" readonly />
                            </div>
                            <div class="mb-3">
