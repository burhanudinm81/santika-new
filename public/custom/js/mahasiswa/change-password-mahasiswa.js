$("document").ready(function () {
    ...
    const modalGantiPassword = $("#modal-ganti-password-mahasiswa");
    const formGantiPassword = $("#form-ganti-password-mahasiswa");

    tableBody.on("click", ".btn-ganti-password", function () {
        const mahasiswaId = $(this).data("id");
        const namaMahasiswa = $(this).data("nama");

        formGantiPassword.find("input[name='mahasiswa_id']").val(mahasiswaId);
        formGantiPassword.find("#nama-mahasiswa").val(namaMahasiswa);
